...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.madson.springbootmongodb.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot com mongDB", "Esta API é utilizada no curso de Spring Boot",
				"Versão 1.0", "https://www.udemy.com/terms", new Contact("Madson", null, null),
